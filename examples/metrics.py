...
class MyApplication(asab.Application):
    def __init__(self):
        ...
        self.MyCounter = metrics_service.create_counter(
            "mycounter", tags={"foo": "bar"}, init_values={"v1": 0, "v2": 0}
        )
        self.MyGauge = metrics_service.create_gauge(
            "mygauge", tags={"foo": "bar"}, init_values={"v1": 0, "v2": 0}
        )
        self.MyEPSCounter = metrics_service.create_eps_counter(
            "myepscounter", tags={"foo": "bar"}, init_values={"event.in": 0}
        )
